...
export interface AddFlowerInput {
...
export interface FlowerFilterInput {
  /** Filter for ID-based criteria. */
  id?: InputMaybe<IdFilter>
...
export interface FlowerSortInput {
...
export interface MutationAddFlowerArgs {
...
export interface MutationRemoveFlowerArgs {
...
export interface MutationUpdateFlowerArgs {
  id: Scalars['ObjectID']['input']
  input: UpdateFlowerInput
}

export interface NameFilterInput {
...
export interface QueryFlowerArgs {
  id: Scalars['ObjectID']['input']
}

export interface QueryFlowersArgs {
...
export interface QuerySensorArgs {
  id: Scalars['ObjectID']['input']
}
...
export interface SensorDataArgs {
  after?: InputMaybe<Scalars['Base64String']['input']>
  before?: InputMaybe<Scalars['Base64String']['input']>
...
export interface SensorDataSortInput {
  /** Specify the field to sort by */
...
export interface SubscriptionLatestSensorDataArgs {
  id: Scalars['ObjectID']['input']
}
...
export interface ValidRangeInput {
  /** Maximum valid range value. */
